...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/transactions/history', [TransactionController::class, 'show'])->name('transactions.history');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/crypto/values', [CryptoController::class, 'changeValues'])->name('crypto.view');
});

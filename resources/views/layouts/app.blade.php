...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex flex-col min-h-screen">
        ...
        <footer class="flex bg-gray-200 py-2 text-center justify-center gap-x-6">
            <a href="https://github.com/liivaq" target="_blank" class="text-neutral-800">
                <svg

    ...
    <div class="h-screen md:flex">
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form method="POST" action="/login" class="bg-white">
                ...
                <p class="text-2xl font-normal text-gray-600 mb-7">Welcome Back</p>
                ...
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
                <p class="mt-4 font-bold">Enter security code no. {{ Session::get('code') }}</p>
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl text-xl">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 icon icon-tabler icon-tabler-dialpad" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
